...
class EntryPointMultiAgentConsole {

}

object EntryPointMultiAgentConsole {
  ...
  def main(args:Array[String]) = {
    ...
    // Load task
    interface.load(taskName, variationIdx = 1, simplificationStr, numAgents = 5)
